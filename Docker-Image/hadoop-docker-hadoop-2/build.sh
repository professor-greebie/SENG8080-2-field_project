...
if [ ! -d "$DIR/build/apache-rat-0.12" ]; then
   wget --no-check-certificate "https://www.apache.org/dyn/mirrors/mirrors.cgi?action=download&filename=creadur/apache-rat-0.12/apache-rat-0.12-bin.tar.gz" -O "$DIR/build/apache-rat.tar.gz"
	cd $DIR/build
